  ...
  //To create an array of input voltage values.
    ...
    for (int l = 24; l < 32; l++){
      ...
      for (int j=0; j<32; j++) {
       ...
       //cout<<j<<endl;
       canvas->cd(j+1);
       g[j] = new TGraph(7, inpVoltages, maxmeanCh);
       g[j]->Draw("AC*");
